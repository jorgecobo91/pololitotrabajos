/**
 * Catálogo de oficios, especialidades y comunas.
 *
 * NOTA: Este archivo es una copia local de packages/shared/src/constants/.
 * Si modificas algo aquí, sincroniza también packages/shared para mantener
 * coherencia con apps/mobile.
 */
